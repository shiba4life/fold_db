...
mod tests {
    ...
    fn test_cli_help() {
        ...
        assert!(
            help_text.contains("store-key"),
            "Help should mention store-key command"
        );
        assert!(
            help_text.contains("retrieve-key"),
            "Help should mention retrieve-key command"
        );
        assert!(
            help_text.contains("delete-key"),
            "Help should mention delete-key command"
        );
        assert!(
            help_text.contains("list-keys"),
            "Help should mention list-keys command"
        );
