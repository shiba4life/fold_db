...
fn test_range_field_with_filter() {
    ...
    let permissions_policy =
        PermissionsPolicy::new(TrustDistance::NoRequirement, TrustDistance::NoRequirement);
    ...
    schema
        .fields
        .insert("test_range".to_string(), FieldVariant::Range(range_field));
...
fn test_range_field_filter_integration() {
    ...
    schema
        .fields
        .insert("temperature".to_string(), FieldVariant::Range(range_field));
