...
impl ErrorUtils {
    ...
    pub fn from_serialization_error(context: &str) -> impl Fn(serde_json::Error) -> SchemaError + '_ {
        move |e| Self::serialization_error(context, e)
    }
    
    /// Helper for converting deserialization errors
    pub fn from_deserialization_error(context: &str) -> impl Fn(serde_json::Error) -> SchemaError + '_ {
